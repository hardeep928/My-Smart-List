...
const MyLists = ({ data, setData, setEditIndex }) => {
  ...
  return (
    <div className="w-full sm:w-[90%] md:max-w-5xl mx-auto mt-16 mb-6 p-6 bg-gray-50 rounded-xl border-2 shadow-lg border-red-500">
      <h1 className="text-2xl font-semibold text-center mb-6">My Tasks List</h1>
